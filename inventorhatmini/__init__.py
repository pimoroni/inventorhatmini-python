...
class InventorHATMini():
    ...
    def __init__(self, address=IOE_ADDRESS, motor_gear_ratio=50, encoder_counts_per_rev=MMME_CPR, init_motors=True, init_servos=True, init_leds=True, start_muted=False):
        ...
        self.__cpr = encoder_counts_per_rev * motor_gear_ratio
