import time
from inventorhatmini import InventorHATMini, MOTOR_A, MOTOR_B, SLOW_DECAY  # , FAST_DECAY
...
STATIONARY_TOGGLE = 0.002       # The time (in seconds) between each direction switch of the motor when using STATIONARY_PLAYBACK
STATIONARY_PLAYBACK = True     # Whether to play the song with or without the motors spinning
